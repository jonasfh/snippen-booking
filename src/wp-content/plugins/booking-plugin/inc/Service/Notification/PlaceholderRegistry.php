	...
	private function register_default_placeholders() {
		$this->register_placeholder(
			array(
				...
				'connected_to' => array( 'user_activation', 'booking_confirmation', 'admin_booking', 'password_reset' ),
		...
		$this->register_placeholder(
			array(
				...
				'connected_to' => array( 'admin_booking', 'booking_confirmation' ),
				'resolver'     => function ( array $context ) {
		...
		$this->register_placeholder(
			array(
				...
				'connected_to' => array( 'booking_confirmation', 'admin_booking' ),
				'resolver'     => function ( array $context ) {
		...
		$this->register_placeholder(
			array(
				...
				'connected_to' => array( 'booking_confirmation' ),
				'resolver'     => function ( array $context ) {
