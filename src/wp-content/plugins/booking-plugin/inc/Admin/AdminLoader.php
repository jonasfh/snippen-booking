		...
		wp_localize_script(
			...
			array(
				...
				'strings' => array(
					...
					'showCommunication'    => __( 'Vis kommunikasjon', 'snippen-booking' ),
					'hideCommunication'    => __( 'Skjul kommunikasjon', 'snippen-booking' ),
					'showAllCommunication' => __( 'Vis all kommunikasjon', 'snippen-booking' ),
					'noFilteredMessages'   => __( 'Ingen meldinger å vise med gjeldende filter.', 'snippen-booking' ),
					'noMessages'           => __( 'Ingen meldinger registrert på denne bookingen ennå.', 'snippen-booking' ),
				),
			)
		);
	}
